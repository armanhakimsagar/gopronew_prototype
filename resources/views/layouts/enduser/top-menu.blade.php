<div id="kt_header" class="kt-header kt-grid__item  kt-header--fixed ">
    ...
    <div class="kt-header-menu-wrapper" id="kt_header_menu_wrapper">
        <div id="kt_header_menu" class="kt-header-menu kt-header-menu-mobile  kt-header-menu--layout-default ">
            <ul class="kt-menu__nav custom-kt-nav-menu">
                <li class="kt-menu__item  kt-menu__item--submenu kt-menu__item--rel" data-ktmenu-submenu-toggle="click"
                    aria-haspopup="true"><a href="javascript:;" class="kt-menu__link kt-menu__toggle"><span
                            class="kt-menu__link-text">Monitors</span><i
                                    ...
                                    <ul class="kt-menu__inner">
                                        <li class="kt-menu__item " aria-haspopup="true"><a
                                                href="" class="kt-menu__link "><i
                                                    ...
                                                    class="kt-menu__link-text"> Standard Monitor</span></a></li>
                                        <li class="kt-menu__item " aria-haspopup="true"><a
                                                href="" class="kt-menu__link "><i
                                                    class="kt-menu__link-bullet kt-menu__link-bullet--line"><span></span></i><span
                                                    class="kt-menu__link-text">Classic Monitor</span></a></li>
                                    </ul>
                                </li>
                            </ul>
                        </div>
                                    ...
                                    <ul class="kt-menu__inner">
                                        <li class="kt-menu__item " aria-haspopup="true"><a
                                                ...
                                                class="kt-menu__link "><i
                                                    class="kt-menu__link-bullet kt-menu__link-bullet--line"><span></span></i><span
                                                    class="kt-menu__link-text"> VTS overview</span></a></li>
                                        <li class="kt-menu__item " aria-haspopup="true"><a
                                                href="{{url('dashboard/d/dashboard')}}" target="_blank"
                                                class="kt-menu__link "><i
                                                    class="kt-menu__link-bullet kt-menu__link-bullet--line"><span></span></i><span
                                                    class="kt-menu__link-text">VMS overview</span></a></li>
                                    </ul>
                                </li>
                            </ul>
                        </div>
                ...
                <li class="kt-menu__item   kt-menu__item--submenu kt-menu__item--rel" data-ktmenu-submenu-toggle="click"
                    aria-haspopup="true"><a href="javascript:;" class="kt-menu__link kt-menu__toggle"><span
                            class="kt-menu__link-text">Quick Reports</span><i
                            class="kt-menu__ver-arrow la la-angle-right"></i></a>
                            ...
                            <ul class="kt-menu__content">
                                <li class="kt-menu__item custom-kt-menu__item">
                                    ...
                                    <ul class="kt-menu__inner">
                                        ...
                                        <li class="kt-menu__item " aria-haspopup="true"><a
                                                href=""
                                                target="_blank" class="kt-menu__link "><i
                                                    class="kt-menu__link-bullet kt-menu__link-bullet--line"><span></span></i><span
                                                    class="kt-menu__link-text">Traveled report</span></a></li>
                                        <li class="kt-menu__item " aria-haspopup="true"><a
                                                href=""
                                                target="_blank" class="kt-menu__link "><i
                                                    class="kt-menu__link-bullet kt-menu__link-bullet--line"><span></span></i><span
                                                    class="kt-menu__link-text">Harsh break report</span></a></li>
                                        <li class="kt-menu__item " aria-haspopup="true"><a
                                                href=""
                                                target="_blank" class="kt-menu__link "><i
                                                    class="kt-menu__link-bullet kt-menu__link-bullet--line"><span></span></i><span
                                                    class="kt-menu__link-text">Engine overview</span></a></li>

                                        <li class="kt-menu__item " aria-haspopup="true"><a
                                                href=""
                                                target="_blank" class="kt-menu__link "><i
                                                    class="kt-menu__link-bullet kt-menu__link-bullet--line"><span></span></i><span
                                                    class="kt-menu__link-text">Trip report</span></a></li>
                                        <li class="kt-menu__item " aria-haspopup="true"><a
                                                href=""
                                                target="_blank" class="kt-menu__link "><i
                                                    class="kt-menu__link-bullet kt-menu__link-bullet--line"><span></span></i><span
                                                    class="kt-menu__link-text">Fuel report</span></a></li>
                                        <li class="kt-menu__item " aria-haspopup="true"><a
                                                href=""
                                                target="_blank" class="kt-menu__link "><i
                                                    class="kt-menu__link-bullet kt-menu__link-bullet--line"><span></span></i><span
                                                    class="kt-menu__link-text">Service uptime / downtime
                                                    report</span></a></li>
                                        <li class="kt-menu__item " aria-haspopup="true"><a
                                                href=""
                                                target="_blank" class="kt-menu__link "><i
                                                    class="kt-menu__link-bullet kt-menu__link-bullet--line"><span></span></i><span
                                                    class="kt-menu__link-text">Map with report</span></a></li>
                                    </ul>
                                </li>
                                <li class="kt-menu__item custom-kt-menu__item ">
                                    <h3 class="kt-menu__heading kt-menu__toggle"><i
                                            class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span
                                            class="kt-menu__link-text">Schedule Reports</span><i
                                            class="kt-menu__ver-arrow la la-angle-right"></i></h3>
                                    <ul class="kt-menu__inner">
                                        <li class="kt-menu__item " aria-haspopup="true"><a
                                                href=""
                                                target="_blank" class="kt-menu__link "><i
                                                    class="kt-menu__link-bullet kt-menu__link-bullet--line"><span></span></i><span
                                                    class="kt-menu__link-text">View schedule report</span></a></li>
                                        <li class="kt-menu__item " aria-haspopup="true"><a
                                                href=""
                                                target="_blank" class="kt-menu__link "><i
                                                    class="kt-menu__link-bullet kt-menu__link-bullet--line"><span></span></i><span
                                                    class="kt-menu__link-text">Alert overview</span></a></li>
                                        <li class="kt-menu__item " aria-haspopup="true"><a
                                                href=""
                                                target="_blank" class="kt-menu__link "><i
                                                    class="kt-menu__link-bullet kt-menu__link-bullet--line"><span></span></i><span
                                                    class="kt-menu__link-text">Alert report</span></a></li>
                                    </ul>
                                </li>
                                <li class="kt-menu__item custom-kt-menu__item">
                                    <h3 class="kt-menu__heading kt-menu__toggle"><i
                                    ...
                                    <ul class="kt-menu__inner">
                                        <li class="kt-menu__item " aria-haspopup="true"><a
                                                ...
                                                target="_blank" class="kt-menu__link "><i
                                                    class="kt-menu__link-bullet kt-menu__link-bullet--line"><span></span></i><span
                                                    class="kt-menu__link-text">Device Management</span></a></li>
                                        <li class="kt-menu__item " aria-haspopup="true"><a href="javascript:;"
                                                class="kt-menu__link "><i
                                                    class="kt-menu__link-bullet kt-menu__link-bullet--line"><span></span></i><span
                                                    class="kt-menu__link-text">Alert setting</span></a></li>
                                        <li class="kt-menu__item " aria-haspopup="true"><a href="javascript:;"
                                                class="kt-menu__link "><i
                                                    class="kt-menu__link-bullet kt-menu__link-bullet--line"><span></span></i><span
                                                    class="kt-menu__link-text">My profile setting</span></a></li>
                                        <li class="kt-menu__item " aria-haspopup="true"><a
                                                href="" target="_blank"
                                                class="kt-menu__link "><i
                                                    class="kt-menu__link-bullet kt-menu__link-bullet--line"><span></span></i><span
                                                    class="kt-menu__link-text">Complain status</span></a></li>
                                    </ul>
                                </li>
                                <li class="kt-menu__item custom-kt-menu__item">
                                    <h3 class="kt-menu__heading kt-menu__toggle"><i
                                            class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span
                                            class="kt-menu__link-text">VMS</span><i
                                            class="kt-menu__ver-arrow la la-angle-right"></i></h3>
                                    <ul class="kt-menu__inner">
                                        <li class="kt-menu__item " aria-haspopup="true"><a
                                                href="{{url('dashboard/d')}}" target="_blank"
                                                class="kt-menu__link "><i
                                                    class="kt-menu__link-bullet kt-menu__link-bullet--line"><span></span></i><span
                                                    class="kt-menu__link-text">Vehicle manager dashboard</span></a></li>
                                        <li class="kt-menu__item " aria-haspopup="true"><a
                                                href="{{url('dashboard/d?page=single_vehicle')}}" target="_blank"
                                                class="kt-menu__link "><i
                                                    class="kt-menu__link-bullet kt-menu__link-bullet--line"><span></span></i><span
                                                    class="kt-menu__link-text">Single vehicle search</span></a></li>
                                        <li class="kt-menu__item " aria-haspopup="true"><a
                                                href=""
                                                target="_blank" class="kt-menu__link "><i
                                                    class="kt-menu__link-bullet kt-menu__link-bullet--line"><span></span></i><span
                                                    class="kt-menu__link-text">Fuel log</span></a></li>
                                        <li class="kt-menu__item " aria-haspopup="true"><a
                                                href=""
                                                target="_blank" class="kt-menu__link "><i
                                                    class="kt-menu__link-bullet kt-menu__link-bullet--line"><span></span></i><span
                                                    class="kt-menu__link-text">Expense log</span></a></li>
                                        <li class="kt-menu__item " aria-haspopup="true"><a
                                                href=""
                                                target="_blank" class="kt-menu__link "><i
                                                    class="kt-menu__link-bullet kt-menu__link-bullet--line"><span></span></i><span
                                                    class="kt-menu__link-text">BRTA document log</span></a></li>
                                    </ul>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div class="kt-menu__subnav">
                            ...
                            <div class="kt-grid-nav kt-grid-nav--skin-light">
                                <div class="kt-grid-nav__row">
                                    <a href="https://play.google.com/store/apps/details?id=net.gomaxtracker.gps_tracker&hl=en"
                                        target="_blank" class="kt-grid-nav__item">
                                        <img src="{{asset('assets/media/logos/google-play.png')}}" alt=""
                                            class="">
                                    </a>
                                ...
                                <div class="kt-grid-nav__row">
                                    <a href="#" class="kt-grid-nav__item">
                                        <img src="{{asset('assets/media/logos/app-store.png')}}" alt="" class="">
                                    </a>
                                    <a href="#" class="kt-grid-nav__item">
                                        <span class="kt-grid-nav__icon">
                                            <svg xmlns="http://www.w3.org/2000/svg"
                ...
                <li class="kt-menu__item  kt-menu__item--submenu kt-menu__item--rel" data-ktmenu-submenu-toggle="click"
                    aria-haspopup="true"><a href="javascript:;" class="kt-menu__link kt-menu__toggle"><span
                            class="kt-menu__link-text">More</span><i
                            class="kt-menu__ver-arrow la la-angle-right"></i></a>
                    <div class="kt-menu__submenu  kt-menu__submenu--fixed kt-menu__submenu--left" style="width:200px">
                        <div class="kt-menu__subnav">
                            <ul class="kt-menu__content">
                                <li class="kt-menu__item custom-kt-menu__item">
                                    <ul class="kt-menu__inner">
                                        <li class="kt-menu__item " aria-haspopup="true"><a
                                                ...
                                                class="kt-menu__link "><i
                                                    class="kt-menu__link-bullet kt-menu__link-bullet--line"><span></span></i><span
                                                    class="kt-menu__link-text">Playback</span></a></li>
                                        <li class="kt-menu__item " aria-haspopup="true"><a
                                                href="" class=" kt-menu__link "><i class="
                                                kt-menu__link-bullet kt-menu__link-bullet--line"><span></span></i><span
                                                    class="kt-menu__link-text">Geo fence</span></a></li>
                                    </ul>
                                </li>
                            </ul>
                        </div>
                ...
                <form>
                        ...
                        <ul class="nav nav-tabs nav-tabs-line nav-tabs-bold nav-tabs-line-3x nav-tabs-line-success kt-notification-item-padding-x"
                            ...
                            <li class="nav-item">
                                <a class="nav-link" data-toggle="tab" href="#topbar_notifications_events" role="tab"
                                    aria-selected="false">VMS Log</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" data-toggle="tab" href="#topbar_notifications_logs" role="tab"
                                    aria-selected="false" onClick="showLoginActivity()">Login Activities</a>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane" id="topbar_notifications_events" role="tabpanel">
                            <div class="kt-notification kt-margin-t-10 kt-margin-b-10 kt-scroll ps" data-scroll="true"
                                data-height="300" data-mobile-height="200" style="height: 300px; overflow: hidden;">
                                <div id="load-vms-log" class="text-center"> <strong>No Data Found</strong> </div>
                                <div class="ps__rail-x" style="left: 0px; bottom: 0px;">
                                    <div class="ps__thumb-x" tabindex="0" style="left: 0px; width: 0px;"></div>
                                </div>
                                <div class="ps__rail-y" style="top: 0px; right: 0px;">
                        ...
                        <div class="tab-pane" id="topbar_notifications_logs" role="tabpanel">
                            <div class="kt-notification kt-margin-t-10 kt-margin-b-10 kt-scroll ps" data-scroll="true"
                                data-height="300" data-mobile-height="200" style="height: 300px; overflow: hidden;">
                                <div id="login_activity_loader" class="col-sm-12 text-center d-none"
                ...
                <ul class="kt-nav kt-margin-t-10 kt-margin-b-10">
                    <li class="kt-nav__item kt-nav__item--active">
                        <a href="#" class="kt-nav__link">
                            <span class="kt-nav__link-icon"><img src="{{asset('assets/media/flags/012-uk.svg')}}"
                                    alt=""></span>
        ...
        <div class="kt-header__topbar-item kt-header__topbar-item--user">
            <div class="kt-header__topbar-wrapper" data-toggle="dropdown" data-offset="0px,0px">
                <div class="kt-header__topbar-user">
                    ...
                    @if(Auth::user()->image)
                    <img src="{{asset('public/uploads/user/'.Auth::user()->image)}}" alt="image">
                    @else
...
function showLoginActivity() {
    load_spinner_activity('show', 'login_activity_loader', '');
    $.ajax({
        type: "GET",
        dataType: "html",
        url: "{{url('dashboard/getLoginActivity')}}/" + "{{auth()->user()->id}}",
        success: function(response) {
            $('#load-login-activity').html(response);
            load_spinner_activity('hide', 'login_activity_loader', '');
        },
    });
}

function load_spinner_activity(type, hide_element, show_element) {
    if (type == 'hide') {
